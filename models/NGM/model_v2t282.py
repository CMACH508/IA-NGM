...
class Net(CNN):
    ...
    def forward(
        ...
        if 'IA' in data_dict:
            ...
            node_srcT1 = alpha * node_src + (1 - alpha) * node_src1
            node_tgtT1 = alpha * node_tgt + (1 - alpha) * node_tgt1
            # g_src.x = node_srcT1[:, :n_points[0], ]
            # g_tgt.x = node_tgtT1[:, :n_points[1], ]
            ...
            # orig_graph0.edge_attr = g_src.edge_attr * alpha + (1 - alpha) * orig_graph0.edge_attr
            # orig_graph1.edge_attr = g_tgt.edge_attr * alpha + (1 - alpha) * orig_graph1.edge_attr
            for b in range(batch_size):
            ...
            global_weights_list0[0] = alpha * global_weights_list0[0] + (1 - alpha) * global_weights_list1[0]
            # for b in range(batch_size):
