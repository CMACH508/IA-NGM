...
class IANet(CNN):
    ...
    def forward(self, data_dict, alpha=0.75):
        ...
        # node_tgtT1 = alpha * node_tgt + (1 - alpha) * node_tgt1
        # for b in range(bs):
        #     g_src[b].x = node_srcT1[b]
        #     g_tgt[b].x = node_tgtT1[b]
        # data_dict['orig_graph_list'] = (g_src, g_tgt)

        data_dict1 = self.t2(data_dict)
        # s2 = data_dict1['ds_mat']
        ...
        # data_dict1['Ns'] = [node_srcT2, node_tgtT2]
        return data_dict1
