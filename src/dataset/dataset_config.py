...
__C.CmuObject = edict()
__C.CmuObject.ROOT_DIR = 'data/Cmu-hotel-house'
__C.CmuObject.CLASSES = ['house', 'hotel']
__C.CmuObject.KPT_LEN = 30
__C.CmuObject.TRAIN_NUM = 5
__C.CmuObject.TRAIN_OFFSET = 0
__C.CmuObject.NS_SRC = 30
__C.CmuObject.NS_TGT = 30
__C.CmuObject.problem = '2GM'
