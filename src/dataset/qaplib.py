...
class QAPLIB(BaseDataset):
    def __init__(self, sets, cls, fetch_online=False):
        ...
        if 'esc32a' in self.data_list:
            self.data_list.remove('esc32a')
        if 'esc32b' in self.data_list:
            self.data_list.remove('esc32b')
        if 'esc32c' in self.data_list:
            self.data_list.remove('esc32c')
        if 'esc32d' in self.data_list:
            self.data_list.remove('esc32d')
        if 'esc32h' in self.data_list:
            self.data_list.remove('esc32h')
        if 'esc64a' in self.data_list:
            self.data_list.remove('esc64a')
        if 'sko42' in self.data_list:
            self.data_list.remove('sko42')
        if 'sko49' in self.data_list:
            self.data_list.remove('sko49')
        if 'sko56' in self.data_list:
            self.data_list.remove('sko56')
        if 'sko64' in self.data_list:
            self.data_list.remove('sko64')
        if 'sko72' in self.data_list:
            self.data_list.remove('sko72')
        if 'tai10a' in self.data_list:
            self.data_list.remove('tai10a')
        if 'tai10b' in self.data_list:
            self.data_list.remove('tai10b')
        if 'tai25a' in self.data_list:
            self.data_list.remove('tai25a')
        if 'tai30a' in self.data_list:
            self.data_list.remove('tai30a')
        if 'tai35a' in self.data_list:
            self.data_list.remove('tai35a')
        if 'tai40a' in self.data_list:
            self.data_list.remove('tai40a')
        if 'tai50a' in self.data_list:
            self.data_list.remove('tai50a')
        if 'tai100a' in self.data_list:
            self.data_list.remove('tai100a')
        if 'tho40' in self.data_list:
            self.data_list.remove('tho40')
        if 'wil50' in self.data_list:
            self.data_list.remove('wil50')

        if 'lipa30a' in self.data_list:
            self.data_list.remove('lipa30a')
        if  'lipa50a' in self.data_list:
            self.data_list.remove('lipa50a')
